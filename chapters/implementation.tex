...
\noindent
The SafeSurf detector integrates with the PhishTank API, a community-driven phishing clearinghouse that maintains a verified database of confirmed phishing URLs. This API is utilized as a "Safe Guard" layer.
\begin{itemize}
...
\noindent
Rather than checking for the HTTPS scheme alone, this module performs a live SSL handshake to verify that the certificate is properly signed and trusted by a standard root CA.
