...
\begin{itemize}
    ...
    \item FastAPI backend for request handling and model execution \cite{ref20}
    \item Hybrid ensemble machine learning model for phishing detection \cite{ref18}
\end{itemize}
\noindent
...
\caption{Dynamic Service Interaction Sequence}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Instantly halts the request, drastically reducing unnecessary ML computation \cite{ref16, ref17}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Calibrated eXtreme Gradient Boosting (XGBoost) \cite{ref7}
    \end{itemize}
    \item Uses:
    \begin{itemize}
...
\begin{itemize}
    \item Developed using React.js \cite{ref22}
    \item Provides:
    \begin{itemize}
...
\begin{enumerate}
    ...
    \item Phase 1: Massive Feature Dataset Extraction (PhiUSIIL Database \cite{ref2})
...
\end{itemize}
\noindent
Future enhancements such as continuous data-drift telemetry alerting and cloud container orchestration \cite{ref21} will further fortify system performance and global scalability.
