...
\noindent
\subsubsubsectionstar{Backend: FastAPI \& Python}
\begin{itemize}
...
\end{itemize}
\noindent
\subsubsubsectionstar{Frontend \& Client: React, Tailwind CSS, JavaScript}
\begin{itemize}
...
\end{itemize}
\noindent
\subsubsubsectionstar{Development \& Execution Environment}
\begin{itemize}
...
\item Interactive, color-coded risk indicators and heuristic breakdowns were implemented to provide users with an intuitive and detailed understanding of detected threats.
\end{itemize}
...
\subsection{Core Data Sources}
The training and evaluation of the predictive models utilize a hybridized data approach, combining three high-performance datasets to ensure maximum coverage across lexical patterns and server infrastructure signals.

\begin{itemize}
    \item \textbf{PhiUSIIL Phishing URL (Website) Dataset} \cite{ref5}:
    Sourced from the UCI Machine Learning Repository (\url{https://archive.ics.uci.edu/dataset/967/phiusiil+phishing+url+dataset}), this dataset provides 235,795 verified instances (134,850 legitimate and 100,945 phishing). It is critical for its 54 raw features and derived security signals like \texttt{CharContinuationRate} and \texttt{URLTitleMatchScore}, ensuring resilience against modern webpage-based spoofing.

    \item \textbf{Phishing Websites Dataset (111 Features)} \cite{ref23}:
    Contributed by Arnav Samal via Kaggle (\url{https://www.kaggle.com/datasets/arnavs19/phishing-websites-dataset}), this dataset is the primary source for the system's \textbf{111-dimensional feature matrix}. It comprises 88,647 instances (58,000 legitimate and 30,647 phishing) meticulously mapped into a continuous numeric vector. This dataset provides the granular technical markers (e.g., DNS TTL, SSL handshake statuses) used to train the XGBoost ensemble core.

    \item \textbf{Phishing Site URLs (Large-Scale)} \cite{ref24}:
    Contributed by Tarun Tiwari via Kaggle (\url{https://www.kaggle.com/datasets/taruntiwarihp/phishing-site-urls}), this massive repository contains 549,346 entries purely mapping URLs to "Good" or "Bad" labels. Due to its sheer volume and lack of missing values, it serves as the foundational corpus for the \textbf{NLP Logistic Regression} pipeline, enabling the system to learn complex textual tokenization patterns across half a million real-world examples.
\end{itemize}
...
\subsubsubsectionstar{Readability and Simplicity}
...
\subsubsubsectionstar{Extensive Library Support}
...
\end{itemize}
\subsubsubsectionstar{Cross-Platform Compatibility}
...
\subsubsubsectionstar{Automatic Memory Management}
...
\subsubsubsectionstar{Dynamic Typing}
...
\subsubsubsectionstar{Scalability}
...
\subsubsubsectionstar{Strong Community Support}
...
\subsubsubsectionstar{Integration with ML and NLP Frameworks}
...
\end{itemize}
\subsubsubsectionstar{Support for Asynchronous and Concurrent Computing}
...
\subsubsubsectionstar{Extensive Data Handling Capabilities}
...
\subsubsubsectionstar{Hardware Specifications}
...
\subsubsubsectionstar{Software and Development Tools}
...
\noindent
\noindent
\subsubsubsectionstar{Machine Learning Ensemble Execution}
\noindent
...
\subsubsubsectionstar{Natural Language Processing (NLP) \& Live Feature Engineering}
...
\subsubsubsectionstar{PhishTank Threat Intelligence API Integration}
...
\subsubsubsectionstar{DNS and WHOIS Infrastructure APIs}
...
\subsubsubsectionstar{Internal Backend REST API (FastAPI)}
...
\subsubsection*{Why was NumPy used in this research?}
\begin{itemize}
...
\subsubsection*{Why was Pandas used in this research?}
\begin{itemize}
...
\subsubsection*{Why were Matplotlib \& Seaborn used in this research?}
\begin{itemize}
...
\subsubsection*{Why was Scikit-learn used in this research?}
\begin{itemize}
...
\subsubsection*{Why was XGBoost used in this research?}
\begin{itemize}
...
\subsubsection{Why was NLTK used in this research?}
